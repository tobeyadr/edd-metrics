...
<div class="edd-metrics-flex">
    ...
    <section class="edd-metrics-boxes">
        ...
        <div class="edd-metrics-box">
            <p class="top-text"><?php _e( 'Lost Customers total', 'edd-metrics' ); ?></p>
            <h2 id="lost-total"></h2>
            <!-- <p class="bottom-text" id="subscriptions-compare"><span></span></p> -->
        </div>
        ...
        <div class="edd-metrics-box">
            <p class="top-text"><?php _e( 'Customers paid beginning of period', 'edd-metrics' ); ?></p>
            <h2 id="beginning-period"></h2>
            <!-- <p class="bottom-text" id="subscriptions-compare"><span></span></p> -->
        </div>


        <div class="edd-metrics-box">
            <p class="top-text"><?php _e( 'Customers paid end of period', 'edd-metrics' ); ?></p>
            <h2 id="end-period"></h2>
            <!-- <p class="bottom-text" id="subscriptions-compare"><span></span></p> -->
        </div>

        <div class="edd-metrics-box">
            <p class="top-text"><?php _e( 'Churn this period', 'edd-metrics' ); ?></p>
            <h2 id="churn-period"></h2>
<!--            <p class="bottom-text" id=""><span class="">This period</span></p>-->

        </div>

        <div class="edd-metrics-box">
            <p class="top-text"><?php _e( 'Churn to date', 'edd-metrics' ); ?></p>
            <h2 id="churn"></h2>
        </div>
